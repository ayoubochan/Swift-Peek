    ...
    <div class="container">
        <form method="POST" action="vues/buy_confirm.php">
            ...
            <?php if (!empty($_SESSION['form_buy']['nom']))
                        echo '<input class="form-control" id="nom" name="nom" type="text" value="'.$_SESSION['form_buy']['nom'].'" />';
                    else 
                        echo '<input class="form-control" id="nom" name="nom" type="text" />';
            ?>
            <label for="rue">Rue</label>
            <?php if (!empty($_SESSION['form_buy']['rue']))
                        echo '<input class="form-control" id="rue" name="rue" type="text" value="'.$_SESSION['form_buy']['rue'].'" />';
                    else 
                        echo '<input class="form-control" id="rue" name="rue" type="text" />';
            ?>
            <label for="ville">Ville</label>
            <?php if (!empty($_SESSION['form_buy']['ville']))
                        echo '<input class="form-control" id="ville" name="ville" type="text" value="'.$_SESSION['form_buy']['ville'].'" />';
                    else 
                        echo '<input class="form-control" id="ville" name="ville" type="text" />';
            ?>
